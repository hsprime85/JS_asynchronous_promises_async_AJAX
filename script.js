...
const getCountryAndNeighbor = function(country){
    ...
    request.addEventListener('load', function(){
        ...
        request.open('GET', `https://restcountries.eu/rest/v2/alpha/${neighbor}`);
        request.send();
...
2. When the image is done loading, append it to the DOM element with the 'images' class, and resolve the promise. The fulfilled value should be the image element itself. In case there is an error loading the image 
(listen for the 'error' event), reject the promise
3. If this part is too tricky for you, just watch the first part of the solution
PART 2
4. Consume the promise using. then and also add an error handler
5. After the image has loaded, pause execution for 2seconds using the 'wait'
...
get3Countries('usa', 'korea (republic of)', 'philippines')
*/
